...
local mapinfo = {
	name        = "1944 - Campaign 1 (US) - Chapter 1",
	shortname   = "1944_Campaign_1_001",
	description = "Welcome to Normandy!",
	author      = "Jose Luis Cercos-Pita",
	version     = "",
	--mutator   = "deployment";
	mapfile     = "maps/1944_Campaign_1_Chapter_001.smf",
	...
	teams = {
		[0] = {startPos = {x = 300, z = 100}},
		[1] = {startPos = {x = 3800, z = 3800}},
	},
